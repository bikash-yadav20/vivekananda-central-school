...
export default function Footer() {
  return (
    ...
    "
            >
              <Image
                src="/images/logos/vcsgk-logo.png"
                alt="Vivekananda Central School Logo"
                width={56}
                height={56}
                priority
            ...
            <p className="mt-6 leading-8 text-slate-300">
              Empowering future leaders through academic excellence, innovation,
              technology, STEM education, robotics, artificial intelligence, and
              character development in a modern learning environment.
            </p>
          ...
          <div>
            <h3 className="text-2xl font-black">Admissions</h3>
            ...
            <div className="mt-10 rounded-3xl border border-yellow-500/20 bg-yellow-500/10 p-6">
              ...
              <p className="mt-4 leading-7 text-slate-300">
                Applications are now being accepted from Playgroup to Grade 10
          ...
          <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-slate-300">
                    NH 15, North Lakhimpur, Assam 787056, India,
                    <br />
                    Gogamukh, District Lakhimpur
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              "
            >
              <Badge variant="secondary">Office Hours</Badge>
          ...
          <div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-slate-300">
                Join Vivekananda Central School and become part of a learning
          ...
          <div className="flex flex-col items-center justify-between gap-6 text-center lg:flex-row lg:text-left">
            ...
            <div className="text-center">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-4">
                {["Excellence", "Integrity", "Innovation", "Leadership"].map(
                  (value) => (
                    <span
                      key={value}
