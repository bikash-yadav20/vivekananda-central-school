        ...
        <RevealOnScroll>
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              Experience Vivekananda Central School
            </motion.div>
            ...
            <p
              ...
              "
            >
              Discover our inspiring classrooms, advanced learning environment,
              dedicated teachers, modern facilities, and vibrant student life.
              Take a virtual journey through Alpine Digital School and witness
              the excellence that shapes future leaders.
            </p>
          </div>
        </RevealOnScroll>
          ...
          <RevealOnScroll>
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                >
                  <source src="/videos/Campus_Tour.mp4" type="video/mp4" />
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-white">Campus Tour</p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="border-t border-white/10 p-8">
                ...
                <p className="mt-3 leading-7 text-slate-300">
                  Excellence in academics, innovation, discipline, leadership,
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-slate-300">
                    Interactive classrooms and technology-driven learning
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-slate-300">
                    A safe, supportive, and disciplined environment where every
                    student is inspired to excel.
                  </p>
                </div>
              </motion.div>
              {/* Card 3 */}
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-slate-300">
                    Outstanding results and achievements, empowering every
                    student to succeed beyond the classroom.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <RevealOnScroll>
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-3 text-slate-300">Years of Excellence</p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-3 text-slate-300">Happy Students</p>
            </motion.div>
            {/* Stat 3 */}
            ...
            >
              ...
              <p className="mt-3 text-slate-300">Commitment</p>
            </motion.div>
          </div>
        </RevealOnScroll>
      </div>
