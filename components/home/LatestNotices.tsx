...
export default function LatestNotices() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setCurrent((prev) => (prev === latestNotices.length - 1 ? 0 : prev + 1));
    }, 5500);
  ...
  const previousSlide = () => {
    setCurrent((prev) => (prev === 0 ? latestNotices.length - 1 : prev - 1));
  };
  ...
  const categoryStyles: Record<string, string> = {
    ...
    Examination: "border-violet-200 bg-violet-50 text-violet-700",

    Fee: "border-amber-200 bg-amber-50 text-amber-700",
        ...
        <RevealOnScroll>
          <div className="mx-auto mb-20 max-w-4xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-slate-600">
              Stay informed with the latest school announcements, examination
              schedules, holidays, fee reminders, admissions, and every
              important update from Vivekananda Central School.
            </p>
          </div>
        </RevealOnScroll>
        {/* ==========================================================
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  ...
                  "
                >
                  From admissions and examination schedules to holidays, fee
                  reminders and school events, our notice board keeps students
                  and parents informed with every important update.
                </p>
