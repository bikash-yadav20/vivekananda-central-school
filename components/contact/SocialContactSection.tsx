...
export default function SocialContactSection() {
  const whatsapp = contactDetails.find((item) => item.title === "WhatsApp");
        ...
        <RevealOnScroll>
          <div className="text-center">
            ...
            <h2 className="mt-6 text-5xl font-black text-[#071A33]">
              Connect With Vivekananda Central School
            </h2>

            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">
              Reach us instantly through WhatsApp or stay updated by following
              our official social media channels for school news, achievements,
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                  Our admission team is available on WhatsApp to answer your
                  questions about admissions, fee structure, scholarships,
                  documents, transportation, campus visits, and academic
                  programs.
                </p>
          ...
          <RevealOnScroll delay={0.2}>
            ...
            >
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                ...
                admissions, competitions, campus life, announcements, and
                educational activities through our official social media
                platforms.
              </p>
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              <div>
                ...
                <p className="mt-4 leading-8 text-slate-600">
                  Receive guidance regarding admissions, eligibility, and
              ...
              <div>
                ...
                <p className="mt-4 leading-8 text-slate-600">
                  Contact our office for academic information, fee details,
                  transportation, and school services.
                </p>
              </div>
        ...
        <RevealOnScroll delay={0.4}>
          ...
          >
            ...
            <div className="relative grid items-center gap-12 lg:grid-cols-[1.3fr_0.7fr]">
              ...
              <div>
                <Badge variant="secondary">Vivekananda Central School</Badge>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                  Our dedicated admission counselors are always ready to answer
                  your questions and guide you throughout the admission journey.
                  Whether you prefer WhatsApp, social media, or visiting our
                  campus, we&apos;re here to help every step of the way.
                </p>
              ...
              <div className="grid gap-5">
                <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur-xl">
                  ...
                  <h3 className="mt-3 text-3xl font-black">6 Days / Week</h3>

                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    Friendly admission support throughout the working week.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur-xl">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    WhatsApp, Phone, Email, Social Media, and Campus Visits.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur-xl">
                  ...
                  <h3 className="mt-3 text-3xl font-black">Quick Assistance</h3>

                  <p className="mt-3 text-sm leading-7 text-slate-300">
                    We strive to respond promptly to every inquiry and support
                    request.
                  </p>
                </div>
              </div>
          ...
          <div className="mx-auto mt-20 max-w-5xl text-center">
            ...
            >
              ...
              <span className="text-sm font-semibold text-slate-700">
                Every question matters — we&apos;re committed to providing
                timely, friendly, and professional support.
              </span>
            </div>

            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-slate-600">
              Vivekananda Central School believes strong communication builds
              strong relationships. Whether you&apos;re exploring admissions,
              seeking academic information, planning a campus visit, or
              following our latest achievements, our team is always happy to
              assist. Connect with us through WhatsApp or follow our official
              social platforms to stay informed about everything happening at
              our school.
            </p>
