...
export const principalData = {
  ...
  experience: "24+ Years",
  email: "principal@vcschool.edu.pk",
  ...
  message: [
    ...
    "Welcome to The Vivekananda Central School, where academic excellence, innovation, and character come together to prepare students for the future.",
...
export const featuredDeveloper = {
  ...
  introduction:
    "Bikash Yadav is the developer of the Vivekananda Central School website and leads the school's digital initiatives. She specializes in AI-powered solutions, modern web development, automation, and practical technology education. Alongside teaching IT and AI concepts, she works on building innovative digital systems that enhance learning and improve the school's online presence.",
  ...
  achievements: [
    "Developer of Vivekananda Central School Website",
...
export const facultyDirectory: FacultyMember[] = [
  ...
  },
  {
    ...
    experience: "4 Years",
    subjects: ["Social Studies", "Quran"],
    achievements: ["Values Excellence"],
    email: "rajatgogoi48@gmail.com",
    description:
      "I am Faiza Muneer, a dedicated and passionate educator with four years of teaching experience. I hold an M.Sc. in Mathematics and currently teach social studies at Vivekananda School. I strive to create a positive and engaging learning environment where students develop both academic knowledge and strong ethical values.",
  },

  {
    ...
    name: "Madhu Gogoi",
    featured: false,
    designation: "Englishl Teacher",
    department: "Englishl",
    image: "/images/faculty/Aqsa.webp",
    qualification: "M.A Assamese, B.Ed",
    experience: "7 Years",
    subjects: ["Assamese"],
    achievements: ["Language Mastery"],
    email: "madhu2@gmail.com",
    description:
      "I am Ms. Aqsa Mehboob, an Englishl Teacher with 6-7 years of teaching experience. I hold an M.A in Englishl and a http://B.Ed degree, which allows me to combine subject expertise with effective classroom practices. My area of specialization is Englishl writing, and I focus on helping students develop strong language skills, comprehension, and creative expression.",
  },
...

  {
    ...
    description:
      "My name is Ayesha. I have completed my Bachelor’s degree in Computer Science (BSCS). For the past two years, I have been a proud member of the Vivekananda Central School family, where I am working as a Pre-School Teacher. I truly enjoy teaching young children and helping them learn and grow in a fun and engaging environment.",
  },
